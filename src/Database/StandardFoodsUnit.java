...
//	constructor========================================================
	...
	public StandardFoodsUnit(float ratio,int eatenfood_id,int food_id,int unit_id) {
	super();
	this.ratio = ratio;
	this.eatenfood_id=eatenfood_id;
	this.food_id=food_id;
	...
	public StandardFoodsUnit(int ratioid, float ratio,int eatenfood_id,int food_id,int unit_id) {
	super();
	this.ratioid = ratioid;
	this.ratio = ratio;
	this.eatenfood_id=eatenfood_id;
