...
public User(double height, double weight, int age, String gender, String pa,
		...
		float meat_bean_egg, float bread_cereals, float fat, float suger,int unitinformation_id,int meal_id) {
	super();
	this.height = height;
	this.weight = weight;
	this.age = age;
	...
	this.suger = suger;
//	foreign key
	this.unitinformation_id=unitinformation_id;
